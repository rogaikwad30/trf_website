        ...
        <div class="form-v4-content" style="margin-top: 12% !important; margin-bottom: 12% !important;">
            ...
            <form class="form-detail" action="#" method="post" id="myform">
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="name" id="name" class="input-text new" title="Enter your full name" required>
                </div>
                <div class="form-group">
                    <div class="form-row form-row-1">
                        <label for="grNo">Gr. No.</label>
                        <input type="text" name="grNo" id="grNo" class="input-text new" title="General Registration Number" required>
                    </div>
                    <div class="form-row form-row-1 ">
                        <label for="contact">Contact Number</label>
                        <input type="text" name="contact" id="contact" class="input-text new" title="Enter whatsapp Number" required>
                    </div>
                </div>
                <div class="form-row">
                    <label for="your_email">Your Email</label>
                    <input type="email" name="your_email" id="your_email" class="input-text new" title="Enter your official email(vit)" pattern ="[a-z0-9._%+-]+@vit\.edu$" required>
                </div>
