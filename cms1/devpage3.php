...
?>
  ...
  <form class="modal-content animate" action="login/login2.php" method="post" >
    ...
    <div class="imgcontainer">
      ...
      <img src="../home4/trflogo6.png" alt="Avatar" class="avatar" style="border-radius:0; height:100px;">
    ...
    <style>
       ...
       <div class="container mt-40">
            <h3 class="text-center" style="font-size:50px; font-weight:bolder;">CORE DEVELOPERS</h3>
            <div class="row mt-30">
                <div class="col-md-2">
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="box16">
                        <img src="nik.png" class="devimg">
                        <div class="box-content">
                            <h3 class="title">NIKHIL GHODKE</h3>
                            <span class="post">Website Lead</span>
                            <ul class="social">
                                <li><a href="#"><i class="fa fa-linkedin" style="transform:translateY(10px);"></i></a></li>
                                <li><a href="#"><i class="fa fa-google-plus" style="transform:translateY(10px);"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="box16">
                        <img src="prat.jpg" class="devimg">
                        <div class="box-content">
                            <h3 class="title">PRATHAMESH GINDODIA</h3>
                            <span class="post">Backend Lead</span>
                            <ul class="social">
                                <li><a href="#"><i class="fa fa-linkedin" style="transform:translateY(10px);"></i></a></li>
                                <li><a href="#"><i class="fa fa-google-plus" style="transform:translateY(10px);"></i></a></li>
                            </ul>
            ...
            <div class="row mt-30">
                <div class="col-md-4 col-sm-6">
                    <div class="box16">
                        <img src="rutu.jpg" class="devimg">
                        <div class="box-content">
                            <h3 class="title">RUTURAJ DESHMUKH</h3>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="box16">
                        <img src="ani.jpg" class="devimg">
                        <div class="box-content">
                            <h3 class="title">Aniket Ghorpade</h3>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="box16">
                        <img src="krish2.jpg" class="devimg">
                        <div class="box-content">
                            <h3 class="title">Krish Agarwal</h3>
                            <span class="post">Backend Developer</span>
                            <ul class="social">
                                <li><a href="#"><i class="fa fa-linkedin" style="transform:translateY(10px);"></i></a></li>
                                <li><a href="#"><i class="fa fa-google-plus" style="transform:translateY(10px);"></i></a></li>
           ...
           <hr>
            <h3 class="text-center" style="font-size:50px; font-weight:bolder;">Administrators</h3>
            <div class="row mt-30">
                <div class="col-md-2">
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="box16">
                        <img src="shal.jpg" class="devimg">
                        <div class="box-content">
                            <h3 class="title">Shalaka Deo</h3>
                            <span class="post">Content Manager</span>
                            <ul class="social">
                                <li><a href="#"><i class="fa fa-linkedin" style="transform:translateY(10px);"></i></a></li>
                                <li><a href="#"><i class="fa fa-google-plus" style="transform:translateY(10px);"></i></a></li>
                            </ul>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="box16">
                        <img src="yash.jpg" class="devimg">
                        <div class="box-content">
                            <h3 class="title">Yash Halgaonkar</h3>
                            <span class="post">Database Manager</span>
                            <ul class="social">
                                <li><a href="#"><i class="fa fa-linkedin" style="transform:translateY(10px);"></i></a></li>
                                <li><a href="#"><i class="fa fa-google-plus" style="transform:translateY(10px);"></i></a></li>
                            </ul>
          ...
          <div class="col-md-3 col-sm-6">
            ...
            <div class="footer-pad">
              ...
              <ul class="list-unstyled " id="ftr">
               <li class="ftrl" id="ftrad"><span>VIT College Upper Indiranagar, <br></span><span>Bibwewadi, </span>Pune-411001 </li>
						<li class="ftrl" id="ftrph">(+91)7020787632</li>
						<li class="ftrl" id="ftren" style="transform: translateY(-20px);">theroboticsforumvitpune@gmail.com</li>
              </ul>
            </div>
          </div>
          <div class="col-md-3">
