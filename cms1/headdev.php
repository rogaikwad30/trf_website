...
@keyframes zoom {
    ...
    .blog_bg{
            background-image: url("https://csharp-station.com/wp-content/uploads/2016/09/Using-the-Stopwatch-Class-to-Log-Time.jpeg");
        }
</style>
 <!--::menu part start::-->
                     ...
                     <ul class="navbar-nav">
						...
						<li class="nav-item dropdown" style="width: 100px;">
                           <a class="nav-link dropdown-toggle headeranchors" href="#" id="navbarDropdown" role="button"
                              ...
                              <img class=" rounded-circle" src="https://cdn.bootstrapsnippet.net/assets/image/dummy-avatar.jpg" style="width: 50%; ">
                           </a>
                           <div class="dropdown-menu" aria-labelledby="navbarDropdown">
