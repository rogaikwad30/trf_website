...
{
 $connection = mysqli_connect("localhost", "root", "", "trf_db");
if(!$connection)
		echo "not connected";
...
$domain=$_POST['domain'];
$qry = "INSERT INTO `quiz`(`quizId`,`quizName`, `discription`,`startDate`,`endDate`,`duration`,`Domain`) VALUES ('$quizId','$quizName','$discription','$startTime','$endTime','$duration','$domain')";
                     ...
                     <form action="quiz_add.php" id="add_name" method="POST">
                          <div class="table-responsive" id="dynamic_field">
                               <table class="table table-bordered" >
                                   ...
                                   <tr>
                                       <td><input type="time" name="Duration" placeholder="Duration of quiz" class="form-control name_list" />
                                       </td>
