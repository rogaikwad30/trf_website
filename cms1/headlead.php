...
@keyframes zoom {
    ...
    .blog_bg{
            background-image: url("header/leadertrophy.jpg");
        }
</style>
 <!--::menu part start::-->
                     ...
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              ...
                              <a class="dropdown-item headeranchors" href="leaderboard3.php" style="background:none !important;font-size:17px;color: red;">Leaderboard</a>
                           </div>
                        </li>
