  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="about.php?user=<?php echo $id;?>"><span class="img" style="background-image: url(../admin/images/<?php echo $img; ?>);"></span><b><?php echo $r1['user_firstname']."  ".$r1['user_lastname']  ;?></b></a></h1>
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li><a href="settings.php?user=<?php echo $id;?>">Change Settings</a></li>
