        ...
        <div class="col-md-8">
            ...
            <section class="mt-4">
                ...
                <ul class="ftco-social mt-3">
		              <li class="ftco-animate"><a href="<?php echo $r1['linkedin_link'];?>"><span class="icon-linkedin"></span></a></li>
		              <li class="ftco-animate"><a href="<?php echo $r1['github_link'];?> "><span class="icon-github"></span></a></li>
		            </ul>
            </section>
        </div>
    </div>
