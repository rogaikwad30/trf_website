...
<?php
    ...
    $page=$_GET['page'];
	  ...
	  $qq="SELECT * FROM `posts` WHERE `post_author`='$name' ";
      $qry="SELECT * FROM `posts` WHERE `post_author`='$name' ORDER BY `post_date` DESC LIMIT $this_page_first,$results_per_page";
