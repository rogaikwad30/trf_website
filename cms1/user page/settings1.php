  ...
  <body style="background-image: url(images/bg5.jpg);">
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="#"><span class="img" style="background-image: url(images/face.jpg);"></span><?php echo $r1['user_firstname']."  ".$r1['user_lastname']  ;?></a></h1>
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li><a href="blog.html">HOME</a></li>
					<li><a href="">About Me</a></li>
					<li><a href="services.html">Tasks</a></li>
         ...
         <div class="col-md-12 mx-auto">
            <div class="myform form ">
               <form action="settings.php?user=<?php echo $_SESSION['user_id']; ?>" method="post" name="login" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      <h2><span style="color: red;">*</span>New Username:</h2>
                     <input type="text" min="0" name="username" id="phone" required  class="form-control my-input">
                  </div>
                      <h2><span style="color: red;">*</span>Old password:</h2>
                     <input type="password" name="passwordcurr" required class="form-control my-input" id="name">
                  </div>
                  <div class="form-group">
                      <h2><span style="color: red;">*</span>New password:</h2>
                     <input type="password" name="password1" required class="form-control my-input" id="email">
                  </div>
                  <div class="form-group">
                      <h2><span style="color: red;">*</span>Confirm password:</h2>
                     <input type="password" min="0" name="password2" id="phone" required class="form-control my-input">
                  </div>
                  <div class="form-group">
                      <h2>Choose profile picture:</h2>
                     <input type="file" min="0" name="img" id="phone"  class="form-control my-input">
                  </div>
  ...
  $r1=mysqli_num_rows($run);
    ...
    $password=mysqli_real_escape_string($con,$row['user_password']);
     if (password_verify($pass,$password)){
       ...
       $qry3="UPDATE `users` SET `user_password`='$pass',`username`='$username',`user_image`='$imgname',`Branch`='$branch',`Year`='$year',`user_email`='$email',`linkedin_link`='$linkedin',`github_link`='$github',`hacker_id`='$hacker' WHERE `user_id`=$id";
       $run=mysqli_query($con,$qry3);
         }
         else
         {
             $pass=password_hash( $newpass2, PASSWORD_BCRYPT, array('cost' => 12));
       $qry3="UPDATE `users` SET `user_password`='$pass',`username`='$username' WHERE `user_id`=$id";
       $run=mysqli_query($con,$qry3);
