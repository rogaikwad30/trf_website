...
@keyframes zoom {
    ...
    .blog_bg{
            background-image: url("header/quiz2.jpg");
        }
</style>
 <!--::menu part start::-->
                     ...
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item headeranchors" href="quiz_mainpage1.php" style="background:none !important;font-size:17px; color: red;">Quizzes</a>
						...
						{?>
                        <li class="nav-item">
                            <a class="nav-link headeranchors" href="javascript:void(0)" onclick="document.getElementById('modal-wrapper').style.display='block'" style="font-size:17px;" >Login/Register</a>
                        </li>
						<?php }
						?>
						<?php //include("includes/header.php");
